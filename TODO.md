...
- [ ] 🟡 `testing-8` Surfpool mainnet-fork integration vs real Raydium/Orca *(testing · 5d · testing-4,6, txbuilder-12)* — surfpool harness + dependency-free cheatcode RPC client + runtime-parity differential GREEN (surfpool_integration.rs); remaining: clone REAL Raydium/Orca pools + the real swap CPI (vs the swap-harness stand-in)
